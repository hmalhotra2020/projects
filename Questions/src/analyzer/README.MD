...
The project is built on Gradle 5x, JDK 1.9 and Junit 4x

After setting up the JDK and downloading the file run the following commands
...
To run iundividual test cases run:
```shell script
gradle test --tests TextAnalysisServiceTests
```
